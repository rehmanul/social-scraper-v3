...
export async function fetchUserPosts(username, count = 30) {
    ...
    try {
        ...
        if (isVercel) {
            console.log('[Instagram Scraper] Running in Serverless/Vercel environment');
            ...
            browser = await playwrightChromium.launch({
             ...
             // Local development
             console.log('[Instagram Scraper] Running in local environment');
        ...
        try {
             ...
             console.log('[Instagram] Content selector timeout, proceeding...');
        }
